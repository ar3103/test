...
- Требуемый персонал (множественный выбор из списка, поддерживает любое число позиций из настроек/инфоблока "Стоимость")
- Количество человек
- Количество часов
- Количество дней
- Имя
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'EXCEL_COMPANY_NAME' => 'FIRSTAR PROMO',
        'EXCEL_CONTACT_WEBSITE' => 'https://firstarpromo.by',
        'EXCEL_CONTACT_EMAIL' => 'sale@firstarpromo.by',
        'EXCEL_CONTACT_PHONE' => '+375 (25) 997-60-95',
        'PROMO_TYPES' => [
...
1. База за персонал: `ставка в час * количество человек * количество дней * часов в день`.
...
Генерация КП в Excel оформлена в виде сметы, близкой к предоставленному макету:

- шапка со строкой сметы и контактным блоком;
- табличная часть по персоналу с колонками механики/локации/ставки/дней/часов;
- выделенный блок итогов справа с цветовой подложкой ключевых строк.

Контакты и название компании в шапке Excel настраиваются через параметры компонента `EXCEL_COMPANY_NAME`, `EXCEL_CONTACT_WEBSITE`, `EXCEL_CONTACT_EMAIL`, `EXCEL_CONTACT_PHONE`.
